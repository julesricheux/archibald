...
Further development plans:
    ...
    - Stabilise the equilibrium computation from response surfaces. In particular,
      ...
      tolerance and allow for extrapolation
"""
...
if __name__=='__main__':
    ...
    # # %%
    # plt.figure()
    # for v in np.linspace(0,4,100):
    #     plt.scatter(v, sailboat.RS['FxHull']((v, heel, 4)))
        
    # for v in np.linspace(0,4,100):
    #     aws, awa = compute_AW(tws, twa, v)
    #     plt.scatter(v, sailboat.RS['FxRig']((aws, awa)))
    # plt.show()
    
    # plt.figure()
    # for d in np.linspace(0,9,100):
    #     plt.scatter(d, sailboat.RS['FyApp']((2, d)))
        
    # for d in np.linspace(0,9,100):
    #     aws, awa = compute_AW(tws, twa, 2)
    #     plt.scatter(d, sailboat.RS['FyRig']((aws, awa)))
    # plt.show()
